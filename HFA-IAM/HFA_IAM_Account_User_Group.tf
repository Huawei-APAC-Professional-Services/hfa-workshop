resource "huaweicloud_identity_group" "hfa_iam_account_usergroup_security" {
    ...
    "Statement" : [
      {
        ...
        "Resource" : {
          "uri" : [
            "/iam/agencies/${module.security_account_base_agency.hfa_security_admin_agency_id}",
            "/iam/agencies/${module.transit_account_base_agency.hfa_security_admin_agency_id}",
            "/iam/agencies/${module.common_account_base_agency.hfa_security_admin_agency_id}",
            "/iam/agencies/${module.app_account_base_agency.hfa_security_admin_agency_id}"
          ]
        }
      }
    ]
...
resource "huaweicloud_identity_group_role_assignment" "iam_account_usergroup_security_allow_assumerole" {
  group_id   = huaweicloud_identity_group.hfa_iam_account_usergroup_security.id
...
output "hfa_iam_account_usergroup_security_id" {
  value = huaweicloud_identity_group.hfa_iam_account_usergroup_security.id
}